            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Master Barang <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('getJenis')}}">Jenis Barang</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> Riwayat Pemesanan <span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Penjualan <span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a><i class="fa fa-clone"></i>Riwayat Penjualan <span class="fa fa-chevron-down"></span></a>
                  </li>
                </ul>
              </div>
            </div>
